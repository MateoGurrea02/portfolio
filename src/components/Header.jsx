...
export default function Header() {
  ...
  return (
    <>
    <div className='z-10 fixed w-full h-40 flex justify-center items-center blur-[2px] bg-contain bg-center  bg-linear-to-b from-gray-800 to-transparent' >
    </div>
    <div className='z-10 fixed w-full h-32 bg-contain bg-repeat blur-[0.7px]' style={{backgroundImage:`url(${image})`}}>
    </div>
    <div className='z-10 fixed w-full h-20 flex justify-center items-center bg-cover bg-center'>
      <div className='text-2xl text-gray-300 flex justify-around w-full lg:w-3/6'>
        ...
        <select defaultValue={i18n.language} onChange={onChangeLang} className='focus:outline-0' >
